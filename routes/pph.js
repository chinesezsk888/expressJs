...
var getList = function(page){
    ...
    var descriptionDemo = Random.cparagraph()+"\n"+Random.cparagraph();
    ...
    var dataList = Mock.mock({
      ...
      "contList|15": [{
          ...
          "description":descriptionDemo,//投诉详情
          "id|+1": pageNum*15,
          "lable|1":["置顶",""],
          "status|1":[1,2,3],//投诉状态 审核通过/已回应/已解决
          "response":[Random.cparagraph(),Random.cparagraph(),Random.cparagraph()],//回应内容 --已回应 已解决
          "responseObject":[Random.cname()],//回应对象
          "quoteCont":{//挂在新闻
            "contId|+1":"1",
